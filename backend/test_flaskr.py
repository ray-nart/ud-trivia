...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_questions_search_without_results(self):
        res = self.client().post("/questions/search",
                                 json={"searchTerm": "geopady"})
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 200)
        self.assertEqual(data["success"], True)

    def test_get_based_on_category(self):
    ...
    def test_404_sent_request_beyond_category(self):
    ...
    def test_422_if_question_does_not_exist(self):
        res = self.client().delete("/questions/70")
        data = json.loads(res.data)
    ...
    def test_play_quiz(self):
        ...
        res = self.client().post('/quizzes', json=data_a)
        data = json.loads(res.data)
